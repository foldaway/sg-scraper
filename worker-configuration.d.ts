/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d666d2bc7ce73e010d3c254327177563)
// Runtime types generated with workerd@1.20260625.1 2026-06-24 nodejs_compat
interface __BaseEnv_Env {
	OUTPUT_BUCKET: R2Bucket;
	BROWSER: BrowserRun;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	TIER: "production" | "development";
	ONEMAP_PROXY_URL: string;
	ONEMAP_PROXY_API_KEY: string;
	SENTRY_DSN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TIER" | "ONEMAP_PROXY_URL" | "ONEMAP_PROXY_API_KEY" | "SENTRY_DSN">> {}
}
